...
export const IconCommit = (p) => (
    <Svg {...p}><circle cx="12" cy="12" r="3.5" /><path d="M1.5 12h7M15.5 12h7" /></Svg>
);
...
export const IconCode = (p) => (
    <Svg {...p}><path d="m18 16 4-4-4-4M6 8l-4 4 4 4M14.5 4l-5 16" /></Svg>
);
...
export const IconGrip = (p) => (
    <Svg {...p} strokeWidth={2.4}>
        <circle cx="9" cy="6" r=".6" /><circle cx="9" cy="12" r=".6" /><circle cx="9" cy="18" r=".6" />
        <circle cx="15" cy="6" r=".6" /><circle cx="15" cy="12" r=".6" /><circle cx="15" cy="18" r=".6" />
    </Svg>
);
...
export const IconEyeOff = (p) => (
    <Svg {...p}>
        <path d="M10.7 6.2A9.9 9.9 0 0 1 12 6c6.4 0 10 6 10 6a17 17 0 0 1-3 3.6M6.2 6.2A17 17 0 0 0 2 12s3.6 6 10 6a9.9 9.9 0 0 0 4-.8" />
        <path d="m2 2 20 20" />
    </Svg>
);
...
export const IconGateway = (p) => (
    <Svg {...p}><path d="M12 2 3 7v10l9 5 9-5V7Z" /><path d="M12 22V12M3 7l9 5 9-5" /></Svg>
);
...
export const IconPlug = (p) => (
    <Svg {...p}><path d="M9 7V3M15 7V3M6 11h12v4a6 6 0 0 1-12 0Z" /><path d="M12 21v-2" /></Svg>
);
...
export const IconLayers = (p) => (
    <Svg {...p}><rect x="2" y="4" width="20" height="6" rx="2" /><rect x="2" y="14" width="20" height="6" rx="2" /></Svg>
);
